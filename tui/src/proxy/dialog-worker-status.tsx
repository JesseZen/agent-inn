...
const LAUNCHERS = ["codex", "claudecode", "grok", "opencode"] as const
          ...
          () => (
            <DialogSelect
              ...
              options={LAUNCHERS.map((launcher) => ({
                title: launcher === "claudecode" ? "Claude Code" : launcher === "grok" ? "Grok Build" : launcher === "opencode" ? "OpenCode" : "Codex CLI",
                value: launcher,
