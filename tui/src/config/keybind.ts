...
export const Definitions = {
  ...
  session_new: keybind("<leader>n", "TODO: future AI chat new session"),
  session_list: keybind("<leader>l", "TODO: future AI chat sessions"),
  ...
  batch_delete: keybind("ctrl+d", "Delete batch"),
  session_change_worker: keybind("ctrl+w", "Change hosted session worker"),
  session_bulk_toggle: keybind("space", "Toggle hosted session selection"),
  session_duplicate: keybind("ctrl+y", "Duplicate hosted session"),
  session_mark_unread: keybind("ctrl+u", "Mark hosted session unread"),
  ...
  model_list: keybind("<leader>m", "TODO: future AI chat model picker"),
  ...
  mcp_list: keybind("none", "TODO: future AI chat MCPs"),
  provider_connect: keybind("none", "TODO: future AI chat placeholder"),
...
export const CommandMap = {
  ...
  session_change_worker: "session.change_worker",
  session_bulk_toggle: "session.bulk.toggle",
  session_duplicate: "session.duplicate",
  session_mark_unread: "session.mark_unread",
