...
function App(props: { onSnapshot?: () => Promise<string[]>; pluginHost: TuiPluginHost }) {
  ...
  const staticCommands = createMemo(() =>
    [
      ...
      {
        name: "session.list",
        title: "TODO: future AI chat sessions",
        category: "AI Chat",
        slashName: "sessions",
        ...
        run: () => {
          ...
          toast.show({
            message: "Placeholder for future AI chat sessions.",
            variant: "info",
          })
        },
      },
      {
        name: "session.new",
        title: "TODO: future AI chat new session",
        category: "AI Chat",
        slashName: "new",
        slashAliases: ["clear"],
        run: () => {
          ...
          // dialog.clear()
          toast.show({
            message: "Placeholder for future AI chat new session.",
            variant: "info",
          })
        },
      },
      ...
      {
        name: "model.list",
        title: "TODO: future AI chat model picker",
        category: "AI Chat",
        slashName: "models",
        ...
        run: () => {
          ...
          toast.show({
            message: "Placeholder for future AI chat model picker.",
            variant: "info",
          })
        },
      },
      ...
      {
        name: "mcp.list",
        title: "TODO: future AI chat MCPs",
        category: "AI Chat",
        slashName: "mcps",
        run: () => {
          ...
          toast.show({
            message: "Placeholder for future AI chat MCPs.",
            variant: "info",
          })
        },
      },
      ...
      },
      {
        ...
        title: "TODO: future AI chat placeholder",
        slashName: "connect",
        run: () => {
          // Future AI chat: restore provider auth when chat mode is ready.
          // dialog.replace(() => <DialogProviderList />)
          toast.show({
            message: "Placeholder for future AI chat implementation.",
            variant: "info",
          })
        },
        category: "AI Chat",
