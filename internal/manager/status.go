...
const (
	...
	EventHostedSessionSnapshotChanged EventType = "hosted.session.snapshot.changed"
	EventHostedSessionDeleted         EventType = "hosted.session.deleted"
	EventManagerResyncRequired        EventType = "manager.resync-required"
)
